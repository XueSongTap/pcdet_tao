...
class DependencyGraph(object):
    ...
    def __init__(self):
        ...
        print("self.REGISTERED_PRUNERS.keys():", self.REGISTERED_PRUNERS.keys())
        print("self.CUSTOMIZED_PRUNERS.keys():", self.CUSTOMIZED_PRUNERS.keys())
    ...
    def _trace(self, model, example_inputs, forward_fn, output_transform):
        ...
        def _record_grad_fn(module, inputs, outputs):
            print("_record_grad_fn, inputs:", inputs)
